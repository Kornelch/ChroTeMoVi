...
while success_count < itera:
    ...
    def nucleolus():
        ...
        r_j=round(random.uniform(r_s5, r_s30),3) #calculate the size of the nucleolus
    ...
    #function to check inside of the nucleus
    def is_in_nu(nr_k):
        global ind
        global L
        global H
    ...
    #function to generate centromeres
    def centromere():
    ...
    def bead_generate_wrap(nr_k_1, ty, dl_ch): #function to restart program
        ...
        for i in range(1):
            ...
            if bead_generate(nr_k_1, ty, dl_ch, max_iter = restart_after) == True:
                success = True
                break
            else:
                print 'Restarting'
